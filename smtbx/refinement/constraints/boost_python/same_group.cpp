  ...
  namespace boost_python {
    ...
    struct same_group_xyz_wrapper  {
      ...
      static void wrap() {
        ...
        class_<wt,
               bases<asu_parameter>,
               std::shared_ptr<wt> >("same_group_xyz", no_init)
    ...
    struct same_group_u_iso_wrapper  {
      ...
      static void wrap() {
        ...
        class_<wt,
               bases<asu_parameter>,
               std::shared_ptr<wt> >("same_group_u_iso", no_init)
          .def(init<af::shared<wt::scatterer_type *> const &,
    ...
    struct same_group_u_star_wrapper  {
      ...
      static void wrap() {
        ...
        class_<wt,
               bases<asu_parameter>,
               std::shared_ptr<wt> >("same_group_u_star", no_init)
          .def(init<af::shared<wt::scatterer_type *> const &,
    ...
    struct same_group_site_proxy_wrapper {
      ...
      static void wrap() {
        ...
        class_<wt,
               ...
               std::shared_ptr<wt> >("same_group_site_proxy", no_init)
    ...
    struct same_group_u_iso_proxy_wrapper {
      ...
      static void wrap() {
        ...
        class_<wt,
               ...
               std::shared_ptr<wt> >("same_group_u_iso_proxy", no_init)
    ...
    struct same_group_u_star_proxy_wrapper {
      ...
      static void wrap() {
        ...
        class_<wt,
               ...
               std::shared_ptr<wt> >("same_group_u_star_proxy", no_init)
