  ...
  namespace boost_python {
    ...
    struct pivoted_rotatable_group_wrapper  {
      ...
      static void wrap() {
        ...
        class_<wt,
               bases<asu_parameter>,
               std::shared_ptr<wt> >("rigid_pivoted_rotatable_group", no_init)
    ...
    struct rotatable_expandable_group_wrapper  {
      ...
      static void wrap() {
        ...
        class_<wt,
               bases<asu_parameter>,
               std::shared_ptr<wt> >("rigid_rotatable_expandable_group", no_init)
          .def(init<site_parameter *,
                    independent_scalar_parameter *,
                    independent_scalar_parameter *,
                    independent_scalar_parameter *,
    ...
    struct riding_expandable_group_wrapper  {
      ...
      static void wrap() {
        ...
        class_<wt,
               bases<asu_parameter>,
               std::shared_ptr<wt> >("rigid_riding_expandable_group", no_init)
          .def(init<site_parameter *,
                    independent_scalar_parameter *,
                    const af::shared<wt::scatterer_type *>&>
               ((arg("pivot"),
    ...
    struct rigid_site_proxy_wrapper {
      ...
      static void wrap() {
        ...
        class_<wt,
               ...
               std::shared_ptr<wt> >("rigid_site_proxy", no_init)
