...
namespace boost_python {
  ...
  struct angle_parameter_wrapper {
    ...
    static void wrap() {
      ...
      class_<wt,
             ...
             std::shared_ptr<wt> >("angle_parameter", no_init)
        .def(init<site_parameter *,
                site_parameter *,
                site_parameter *,
                double>
  ...
  struct secondary_xh2_sites_wrapper
  {
    ...
    static void wrap() {
      ...
      class_<wt,
             bases<asu_parameter>,
             std::shared_ptr<wt> >("secondary_xh2_sites", no_init)
        .def(init<site_parameter *,
                site_parameter *,
                site_parameter *,
                independent_scalar_parameter *,
  ...
  struct tertiary_xh_site_wrapper
  {
    ...
    static void wrap() {
      ...
      class_<wt,
             bases<asu_parameter>,
             std::shared_ptr<wt> >("tertiary_xh_site", no_init)
        .def(init<site_parameter *,
                  site_parameter *,
                  site_parameter *,
                  site_parameter *,
  ...
  struct secondary_planar_xh_site_wrapper
  {
    ...
    static void wrap() {
      ...
      class_<wt,
             bases<asu_parameter>,
             std::shared_ptr<wt> >("secondary_planar_xh_site", no_init)
        .def(init<site_parameter *,
                  site_parameter *,
                  site_parameter *,
                  independent_scalar_parameter *,
  ...
  struct terminal_planar_xh2_sites_wrapper
  {
    ...
    static void wrap() {
      ...
      class_<wt,
             bases<asu_parameter>,
             std::shared_ptr<wt> >("terminal_planar_xh2_sites", no_init)
        .def(init<site_parameter *,
                  site_parameter *,
                  site_parameter *,
                  independent_scalar_parameter *,
  ...
  struct terminal_linear_ch_site_wrapper
  {
    ...
    static void wrap() {
      ...
      class_<wt,
             bases<asu_parameter>,
             std::shared_ptr<wt> >("terminal_linear_ch_site", no_init)
        .def(init<site_parameter *,
                  site_parameter *,
                  independent_scalar_parameter *,
                  wt::scatterer_type *>
  ...
  struct polyhedral_bh_site_wrapper
  {
    ...
    static void wrap() {
      ...
      class_<wt,
             bases<asu_parameter>,
             std::shared_ptr<wt> >("polyhedral_bh_site", no_init)
        .def(init<site_parameter *,
