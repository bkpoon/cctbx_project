// Modified version of cmaes_interface.h with certain functions marked
// with "extern"
...
extern void cmaes_exit(cmaes_t *);

/* --- core functions --- */
extern double * const * cmaes_SamplePopulation(cmaes_t *);
extern double *         cmaes_UpdateDistribution(cmaes_t *,
                                                 const double *rgFitnessValues);
extern const char *     cmaes_TestForTermination(cmaes_t *);
...
/* --- getter functions --- */
extern double         cmaes_Get(cmaes_t *, char const *keyword);
const double * cmaes_GetPtr(cmaes_t *, char const *keyword); /* e.g. "xbestever" */
extern double *       cmaes_GetNew( cmaes_t *t, char const *keyword);
